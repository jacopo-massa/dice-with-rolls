...
def _get_all_users():
    ...
    return render_template("users.html", users=users, home_url=HOME_URL)
...
def _get_followers(id_user):
    ...
    return render_template("followers.html", users=followers, home_url=HOME_URL)
